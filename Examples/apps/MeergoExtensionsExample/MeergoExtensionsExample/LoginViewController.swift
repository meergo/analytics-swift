...
extension LoginViewController: ASAuthorizationControllerDelegate {
    ...
    private func saveUserInKeychain(_ userIdentifier: String) {
        ...
        //change 'co.alancharles.MeergoExtensionsExample' to your identifier
        do {
            try KeychainItem(service: "co.alancharles.MeergoExtensionsExample", account: "userIdentifier").saveItem(userIdentifier)
