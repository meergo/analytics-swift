...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "co.alancharles.MeergoExtensionsExample", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "co.alancharles.MeergoExtensionsExample", account: "userIdentifier").deleteItem()
        } catch {
